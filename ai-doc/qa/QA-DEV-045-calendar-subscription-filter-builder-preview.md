...
- `verify:dev-045-calendar-subscription-remote-readiness`：Pass，19 pass / 0 fail；此 gate 只驗證本機 migration / Edge / client / governance artifacts 已具備 remote gate 前置條件，不連線 Supabase、不套 migration、不部署 Edge。
