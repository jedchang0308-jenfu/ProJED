...
- Preferred：local Supabase DB smoke 已完成；下一步提供可用 staging / Supabase branch 或進 deployment-release-gate，先完成 remote migration / Edge deploy 前後的 live `.ics` preview/feed parity smoke 與 rollback evidence。
