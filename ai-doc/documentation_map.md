...
| DEV-025 | DB Read-only Preflight Passed / Fixture Readiness Harness Added / Mutating QC Pending | 正式 DB 已具備 RPC / grants / constraints；已新增 read-only fixture-readiness harness。下一步需 staging / disposable fixture 或 production-safe test workspace/board，先驗證 fixture 標記與最小資料形狀，再驗證 RPC、RLS、audit log、資料一致性與 RAG visibility。 |
