...
| `ai-doc/specs/SPEC-029-mobile-pan-first-touch-interactions.md` | Phase 1B Implemented / Local Automated QA Passed / Production Not Deployed / Physical Phone Supplemental Pending | DEV-029 | 定義手機 BoardView / Kanban / TaskWorkbench pan-first 觸控仲裁，手機 task surface 與拖曳把手短滑不誤開詳情且可 pan，無位移 tap 仍開詳情；2026-07-05 Phase 1B 已完成手機頂部文字 compact action rail、長按拖放排序、touchcancel / pointercancel / blur / visibility / Escape / timeout 退出防卡死。 |
