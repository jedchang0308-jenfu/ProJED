...
| Production release / live smoke | Same Spec Phase | Phase 3 | Phase 2 local gates pass, user authorizes deployment-release-gate, and Level 3 production-like smoke path exists or risk is explicitly accepted |
