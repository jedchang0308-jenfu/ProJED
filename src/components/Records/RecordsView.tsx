...
const formatRecordType = (type: KnowledgeRecord['type']) => {
  switch (type) {
    ...
    case 'task_collection': return '收藏任務';
    default: return '未知紀錄';
  }
};
...
const RecordsView: React.FC = () => {
  ...
  const sections = [
    { key: 'task_collection' as const, label: '收藏任務' },
