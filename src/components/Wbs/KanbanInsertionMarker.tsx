...
export const KanbanInsertionMarker: React.FC<KanbanInsertionMarkerProps> = ({
  ...
  >
    <span
      className={`${emphasized || !compact ? 'h-2.5 w-2.5' : 'h-2 w-2'} shrink-0 rounded-full bg-primary shadow-[0_0_0_2px_rgba(59,130,246,0.12)]`}
      data-kanban-insertion-dot="true"
    />
    <span
      className={`${emphasized || !compact ? 'h-2' : 'h-1.5'} min-w-0 flex-1 rounded-full bg-primary shadow-[0_0_0_1px_rgba(59,130,246,0.10)]`}
