...
const sourceContracts: Array<[string, string[]]> = [
  ...
  ['src/index.css', ['data-kanban-view-size="large"', '--kanban-column-width: 630px', '--kanban-l1-l2-title-size: 35px', '--kanban-l3-title-size: 30px']],
];
...
console.log(JSON.stringify({
  ...
  result: 'PASS',
  checks: decisions.length + sourceContracts.reduce((count, [, needles]) => count + needles.length, 0) + 5,
