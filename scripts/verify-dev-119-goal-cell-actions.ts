...
check('P16', 'DEV-116 verifier baselines include the SPEC-121 R8 compact Goal geometry oracle', hash('scripts/verify-dev-116-goal-mode.ts') === 'f1113067ba3861b855da57648d6db82dffc74ee26fada0c7b96c68eae30db6bf' && hash('scripts/verify-dev-116-goal-mode-browser.pw.js') === 'c079b650acef5df578f8b551093463f36442b7b5538159e05aa7f89da97b8c47');
