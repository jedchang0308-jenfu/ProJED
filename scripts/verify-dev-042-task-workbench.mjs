...
assert(
  ...
  containsAll(taskZoneView, [
    ...
    'toTaskSortString(left.endDate || left.startDate || getTaskCreatedAt(left))',
    'const dateCompare = leftDate.localeCompare(rightDate)',
    "toTaskSortString(left.title).localeCompare(toTaskSortString(right.title), 'zh-Hant')",
    'toTaskSortString(left.id).localeCompare(toTaskSortString(right.id))',
    'workbenchItems',
