...
const checks = [
  ...
  ['meeting draft footer controls are removed and explicit save/exit actions stay in overflow', !files.sidebar.includes('data-record-meeting-actions') && !files.sidebar.includes('data-record-meeting-save-draft') && files.sidebar.includes('data-meeting-draft-overflow-menu') && files.sidebar.includes('data-meeting-draft-save') && files.sidebar.includes('data-meeting-draft-save-and-exit') && files.sidebar.includes('儲存草稿') && files.sidebar.includes('儲存並離開') && files.sidebar.includes('刪除並離開') && files.sidebar.includes('data-meeting-workflow-step={step.stage}')],
